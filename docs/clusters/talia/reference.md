...
**Slug:** `talia`
**Status:** Migrated from Doc 1 Annex C/D, 2026-08-09. Guarded by `scripts/pre-commit` per Doc 4 #09. Unit-type / facade / image depth from staging Batch 001 (2026-08-13); amenities from Batch 002 (2026-08-13); payment / summary / body from Batch 003 (2026-08-13). Golden Beach strip Valley-wide places from Batch 004 (2026-08-13).
**Source:** Relocated from Doc 1 Annex C/D, then Batches 001–004 (Emaar floor-plan PDF + brochure + cluster map + payment PDF, source `a1000000-0000-4000-8000-000000000001`).
...
Style is layout-determining here (`unit_types.layout` = `{facade_style}-{label}`, e.g. `cyrus-a`). Per-layout `unit_count` still null (site-plan colour pass not done). All rows except as noted: `maids_room = true`, `bathrooms` 3.5 (3BR) / 4.0 (4BR), confidence corroborated. 4BR rows have `ground_floor_bedroom = true`. Pharo has no 4BR-B/C pages in the source PDF.

| facade_style | bedrooms | label | layout | bua_min | bua_max | unit_count | bathrooms |
|---|---|---|---|---|---|---|---|
| cyrus | 3 | A | cyrus-a | 2097 | 2097 | — | 3.5 |
| cyrus | 3 | B | cyrus-b | 2100 | 2100 | — | 3.5 |
| cyrus | 4 | A | cyrus-a | 2217 | 2217 | — | 4.0 |
| cyrus | 4 | B | cyrus-b | 2248 | 2248 | — | 4.0 |
| elio | 3 | A | elio-a | 1864 | 1897 | — | 3.5 |
| elio | 3 | B | elio-b | 1862 | 1921 | — | 3.5 |
| elio | 4 | A | elio-a | 2210 | 2210 | — | 4.0 |
| elio | 4 | B | elio-b | 2210 | 2210 | — | 4.0 |
| pharo | 3 | A | pharo-a | 2090 | 2090 | — | 3.5 |
| pharo | 3 | B | pharo-b | 2035 | 2064 | — | 3.5 |
| pharo | 3 | C | pharo-c | 2036 | 2040 | — | 3.5 |
| pharo | 4 | A | pharo-a | 2187 | 2187 | — | 4.0 |
| pharo | 4 | D | pharo-d | 2189 | 2189 | — | 4.0 |
| pharo | 4 | E | pharo-e | 2189 | 2189 | — | 4.0 |
...
Not promoted yet. Numbered colour site plan exists; resolving 330 units / plexes needs a separate map pass. Cluster total 330 remains the register figure.
...
See [`staging.md`](./staging.md) for any facts pending promotion into this reference. Batches 001–004 promoted 2026-08-13. Still open: units/plexes/per-layout `unit_count`; publish Talia amenities; `single_row`; plot sizes; pricing.
